...
public class InscripcionCurso extends javax.swing.JInternalFrame {
    ...
    private void ValidarEntrada() {
        // --- Validación Nombre Curso (máximo 20 caracteres, solo letras y números) ---
        jtxtNombreCurso.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                ...
                // Verificar longitud máxima (20 caracteres según varchar(20))
                if (currentLength >= 20 && (c != KeyEvent.VK_BACK_SPACE && c != KeyEvent.VK_DELETE)) {
                    e.consume();
                    JOptionPane.showMessageDialog(jtxtNombreCurso,
                            "El campo Nombre de Curso no puede exceder los 20 caracteres.",
                            "Límite alcanzado",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }

                // Permitir solo letras, números y espacios (bloquear caracteres especiales)
    ...
    public void eliminarDatos() {
        try {
            ...
            if (idCursoSeleccionado == -1) {
                JOptionPane.showMessageDialog(null, "Debe seleccionar un curso de la tabla para eliminar");
                return;
            }

            int confirmacion = JOptionPane.showConfirmDialog(
                    null,
                    "¿Está seguro de eliminar el curso: " + jtxtNombreCurso.getText() + "?",
            ...
            if (confirmacion == JOptionPane.YES_OPTION) {
                ...
                psd.setInt(1, idCursoSeleccionado);
                ...
                if (n > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "No se encontró el curso a eliminar");
                }
    ...
    public void editarDatos() {
        ...
        if (jtxtNombreCurso.getText().trim().isEmpty()) {
        ...
        try {
            ...
            psd.setString(1, jtxtNombreCurso.getText().trim());
            ...
            if (opc > 0) {
                ...
                JOptionPane.showMessageDialog(null, "No se encontró el curso o no se realizaron cambios.");
            }
